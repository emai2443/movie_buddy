...
export const Movie = ({ title, poster_path, overview, vote_average,id, release_date, original_language }) => {
  ...
  <div className="movie" >
    ...
    <div id={id} className="modal" onClick={()=>spanClick(id)} style={{display: 'none'}}>
      <div className="modal-content">
        ...
        <div className="randomRating">
          ...
          <div className="closeFlex">
            <span className="close" onClick={()=>spanClick(id)}>&times;</span>
          </div>
        </div>
